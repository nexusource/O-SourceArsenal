...
## 内容
attribute @s minecraft:generic.max_health modifier add 0-0-0-0-1 lv 200 add
attribute @s minecraft:generic.attack_damage modifier add 0-0-0-0-1 lv 50 add
